# Hướng dẫn tích hợp giám sát minIO cluster
## Đầu bài:
- Giám sát tải tới cụm minIO và trạng thái sử dụng tài nguyên của minIO cluster.
- Tự động cập nhật cụm minIO mới triển khai lên hệ thống giám sát.

## Giải pháp:
 - Consul để discover cụm minIO cluster mới triển khai.
